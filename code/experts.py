...
def get_experts(course_name, question, num_experts=3, max_tokens = 8192):
    messages = [{"role":"system", "content":f"You are an MIT Professor of Computer Science and Mathematics teaching the {course_name} course.\n"},
    ...
    try:
        ...
        time.sleep(30)
        return get_experts(course_name, question)
